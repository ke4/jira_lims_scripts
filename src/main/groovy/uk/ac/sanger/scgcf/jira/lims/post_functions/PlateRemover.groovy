...
import uk.ac.sanger.scgcf.jira.lims.utils.PlateRemovalParameterHolder
 ...
 *
 * This script should be passed 2 parameters: the name of the workflow
 * and the name of the custom fields containing the plate ids
 *
...
class PlateRemover {
    ...
    Map<String, PlateRemovalParameterHolder> plateRemovalParameterHolders
    Issue curIssue
    String workflowName
    ...
    public void execute() {
        ...
        if(customField != null) {
            ...
            PlateRemovalParameterHolder parameters = plateRemovalParameterHolders.get(workflowName)
            parameters.plateIdsToRemove = arrayPlateIds
