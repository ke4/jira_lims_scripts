 ...
 * to the current Lysos Buffer Request issue via a function in {@code LysisBufferRequestPostFunctions}.
 *
...
def customField =  customFieldMngr.getCustomFieldObject(ConfigReader.getCFId('CURRENT_LYSIS_BUFFER_REAGENTS'))
